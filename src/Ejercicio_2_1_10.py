...
def main():
    ...
    if tipo_de_pizza(tipo_pizza) == True:
        ...
        pizza = pizza_veg(ingrediente)
        print(f"Tu pizza vegetariana lleva {pizza}, Tomate y Mozzarella.")
    elif tipo_de_pizza(tipo_pizza) == False:
        ...
        pizza = pizza_no_veg(ingrediente)
